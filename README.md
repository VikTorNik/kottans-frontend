...
* Почав цей розділ 11.09.2022
* Окреме репо роботи
https://github.com/VikTorNik/a-tiny-JS-world--OOP
* Демонстрація роботи
https://viktornik.github.io/a-tiny-JS-world--OOP/
* Pull requests
https://github.com/kottans/frontend-2022-homeworks/pull/536
* З класами працювати краще ніж з прототипами зважаючи на те, що код виходить більш красивим, охайним. Якщо проект великий, то кількість коду буде значно меншою. Якось стикався з думкою щодо класи не має сенсу використовувати у комерційній розробці на JS. Було б цікаво почитати щодо необхідності застосування класів для тих, чи інших проектів.
* Також мені не зрозуміло чому за вимогами завдання заборонено використовувати методи Object - values, keys, entires. З ними вивід інформації на екран можна було зробити загалом у два рядка.
* Закінчив цей розділ 12.09.2022

## 12. Memory pair game

* Почав цей розділ 13.09.2022
* Окреме репо роботи
https://github.com/VikTorNik/Memory_Game
* Демонстрація роботи
https://viktornik.github.io/Memory_Game/
* Pull requests
https://github.com/kottans/frontend-2022-homeworks/pull/621
...
1. можливо подія не доходить до відповідного класу так як динамічно оновлюється DOM
2. можливо за рахунок використання setInterval
...
* Закінчив цей розділ 19.09.2022

## 14. Friends App

* Почав цей розділ 20.09.2022
* Окреме репо роботи
https://github.com/VikTorNik/Freinds
* Демонстрація роботи
https://viktornik.github.io/Freinds/
* Pull requests
https://github.com/kottans/frontend-2022-homeworks/pull/675
...
* Закінчив цей розділ 25.09.2022
